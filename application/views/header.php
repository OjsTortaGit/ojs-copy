...
<head>
    ...
    <link href="<?php echo base_url("assets/bootstrap-5.3.2-dist/css/bootstrap.min.css"); ?>" rel="stylesheet">
    <link href="<?php echo base_url("assets/bootstrap-5.3.2-dist/css/toastr.min.css"); ?>" rel="stylesheet">
    <script src="<?php echo base_url("assets/bootstrap-5.3.2-dist/js/bootstrap.bundle.min.js"); ?>"></script>

    <!-- Datatables CSS -->
    <link href="<?php echo base_url('assets/DataTables/DataTables-1.11.3/css/dataTables.bootstrap5.css'); ?>"
        rel="stylesheet">
